...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="py-20 bg-gradient-to-br from-gray-900 to-slate-900"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-4">
              <div className="group flex items-center gap-4 p-6 bg-gray-800/50 backdrop-blur-md rounded-2xl border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold text-lg">rajakansari833@gmail.com</p>
              ...
              <div className="group flex items-center gap-4 p-6 bg-gray-800/50 backdrop-blur-md rounded-2xl border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold text-lg">+977 9827310498</p>
                  <p className="text-xs text-gray-400">Available 9 AM - 6 PM NPT</p>
                </div>
              </div>
              ...
              <div className="group flex items-center gap-4 p-6 bg-gray-800/50 backdrop-blur-md rounded-2xl border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold text-lg">Dharan-1, Sunsari</p>
                  <p className="text-xs text-gray-400">Nepal (UTC+5:45)</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="group p-4 bg-gray-800/50 backdrop-blur-md rounded-2xl border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-110"
                >
            ...
            {/* Availability Status */}
            <div className="p-6 bg-gradient-to-r from-green-900/20 to-blue-900/20 rounded-2xl border border-green-800">
          ...
          <div className="lg:col-span-3">
            <div className="bg-gray-900/70 backdrop-blur-md rounded-3xl border border-white/20 p-8 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-800/80 border border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 text-white placeholder-white/70"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-gray-800/80 border border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 text-white"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={6}
                    className="w-full px-4 py-3 bg-gray-800/80 border border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 text-white placeholder-white/70 resize-none"
        ...
        {/* Footer */}
        <footer className="mt-20 pt-8 border-t border-gray-700 text-center text-sm flex flex-col items-center gap-2">
          <div className="flex items-center justify-center gap-3 mb-1">
            <a
              ...
              rel="noopener noreferrer"
              aria-label="GitHub"
              className="inline-flex items-center justify-center p-2 rounded-full hover:bg-gray-800 transition-colors"
            >
