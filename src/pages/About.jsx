            ...
            <div className="relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-300">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <a href="https://drive.google.com/file/d/1aVF8xZUq12kVtEQaguz9jdZEmARIU4pO/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="text-gray-700 dark:text-gray-300 underline hover:text-orange-600">{t('about.aws_cloud')}</a>
                </div>
                <div className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                  <a href="https://drive.google.com/file/d/1aVF8xZUq12kVtEQaguz9jdZEmARIU4pO/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="text-gray-700 dark:text-gray-300 underline hover:text-blue-600">{t('about.aws_ml')}</a>
                </div>
                <div className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                  <a href="https://drive.google.com/file/d/10p6e0CXGeQ5SnQXnQzbT6uUY4OMNDCez/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="text-gray-700 dark:text-gray-300 underline hover:text-green-600">{t('about.aws_nlp')}</a>
                </div>
                <div className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-purple-500 rounded-full"></span>
                  <a href="https://drive.google.com/file/d/1wPgQXGiCQoHCVH90HDn9ZBQydu5H9uwk/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="text-gray-700 dark:text-gray-300 underline hover:text-purple-600">{t('about.cpp')}</a>
                </div>
              </div>
            </div>
          </div>
